...
@constraint(M, Balance[t in T, y in Y], C_PV*PV_CF[t,y] + b_dh[t,y] - b_ch[t,y] -  - g_ex[t,y] + g_im[t,y] == 0)

@constraint(M, SOC[t in T, y in Y; t>1 && y!=1], b_st[t,y] == b_st[t-1,y] - b_dh[t,y]/Battery_par["Discharging_eff"] + b_ch[t,y]*Battery_par["Charging_eff"])

@constraint(M, SOC_LastT[t in T, y in Y; t == last(T) && y>1], b_st[t,y] == b_st[last(T),y-1] - b_dh[t,y]/Battery_par["Discharging_eff"] + b_ch[t,y]*Battery_par["Charging_eff"])
